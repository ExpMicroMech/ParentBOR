...
settings.file.fname=('EBW3a_A_Init_cropped_v5_SG.h5');%file name including file type
...
settings.grains.smallGrains = 1; % threshold grain size below which the grains will be removed
...
settings.reconstruct.inflationPower = 1.2; % controls MCL algorithm 
...
Plotting_Part2_quick(settings,PlotOpt,grains);
