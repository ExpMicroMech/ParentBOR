function [grains]=calcAlphaVariantsNewBeta(grains,settings,BetaSetNo)
% CALCALPHAVARIANTSNEWBETA determines the alpha variant no for each alpha 
% grain. It then finds the unique alpha variants for each beta grain. This 
% version is specifically for use after updating the beta grain
% orientations.
%
%   Inputs:
...
%   BetaSetNo - which beta grain set to use to calculate the alpha variants
%
%   Outputs:
%   grains - structure containing:  
...
%% Beta grain orientations
switch BetaSetNo
    case 1
        bcc_grains=grains.AltBeta.opt1.betaGrains; %Beta/BCC grains - alternative set 1
    case 2
        bcc_grains=grains.AltBeta.opt2.betaGrains; %Beta/BCC grains - alternative set 2
    case 3
        bcc_grains=grains.AltBeta.opt3.betaGrains; %Beta/BCC grains - alternative set 3
    case 4
        bcc_grains=grains.AltBeta.opt4.betaGrains; %Beta/BCC grains - alternative set 4
    case 5
        bcc_grains=grains.AltBeta.opt5.betaGrains; %Beta/BCC grains - alternative set 5
    case 6
        bcc_grains=grains.AltBeta.opt6.betaGrains; %Beta/BCC grains - alternative set 6
end
%% Identify alpha variants

% Create a wait bar to monitor progress
h = waitbar(0,'Re-calculating alpha variants. Please wait...','Name','Alpha variant analysis',...
            'CreateCancelBtn',...
...
switch BetaSetNo
    case 1
        grains.AltBeta.opt1.alphaGrains=grains_hcp; %alpha/HCP
        grains.AltBeta.opt1.betaGrains=bcc_grains; %beta/BCC
        grains.AltBeta.opt1.UniqueAlphaVariants=Unique; %unique alpha variant Nos
    case 2
        grains.AltBeta.opt2.alphaGrains=grains_hcp; %alpha/HCP
        grains.AltBeta.opt2.betaGrains=bcc_grains; %beta/BCC
        grains.AltBeta.opt2.UniqueAlphaVariants=Unique; %unique alpha variant Nos
    case 3
        grains.AltBeta.opt3.alphaGrains=grains_hcp; %alpha/HCP
        grains.AltBeta.opt3.betaGrains=bcc_grains; %beta/BCC
        grains.AltBeta.opt3.UniqueAlphaVariants=Unique; %unique alpha variant Nos
    case 4
        grains.AltBeta.opt4.alphaGrains=grains_hcp; %alpha/HCP
        grains.AltBeta.opt4.betaGrains=bcc_grains; %beta/BCC
        grains.AltBeta.opt4.UniqueAlphaVariants=Unique; %unique alpha variant Nos
    case 5
        grains.AltBeta.opt5.alphaGrains=grains_hcp; %alpha/HCP
        grains.AltBeta.opt5.betaGrains=bcc_grains; %beta/BCC
        grains.AltBeta.opt5.UniqueAlphaVariants=Unique; %unique alpha variant Nos
    case 6
        grains.AltBeta.opt6.alphaGrains=grains_hcp; %alpha/HCP
        grains.AltBeta.opt6.betaGrains=bcc_grains; %beta/BCC
        grains.AltBeta.opt6.UniqueAlphaVariants=Unique; %unique alpha variant Nos
end
%% delete wait bar
delete (h);
